    ...
    <div class="modal-content">
      ...
      <form method="post" class="form-stok">
        <div class="modal-body mx-3">
            ...
            <div class="md-form mb-0" id="md-form-jumlah">
            ...
            <div class="md-form mb-0 hidden" id="md-form-batas">
              <input type="text" id="defaultForm-batas" class="form-control validate mb-3" name="ip-batas">
              <label for="defaultForm-batas">Batas Stok</label>
            </div>
        </div>
...
<!-------------- End modal stok -------------->
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $("#set-stok").click(function(){
        var data = $('#modalstok .form-stok').serialize();
        $.ajax({
          type: 'POST',
          url: "controllers/stok.ctrl.php?ket=set-stok",
          data: data,
          success: function() {
            console.log("sukses edit")
            $('#table-stok').DataTable().ajax.reload();
      ...
      $("#updatebatas-stok").click(function(){
        var data = $('#modalstok .form-stok').serialize();
        $.ajax({
          type: 'POST',
          url: "controllers/stok.ctrl.php?ket=updatebatas-stok",
          data: data,
          success: function() {
            console.log("sukses edit")
            $('#table-stok').DataTable().ajax.reload();
