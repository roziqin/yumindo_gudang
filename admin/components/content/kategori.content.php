<?php include '../modals/kategori.modal.php'; ?>
    ...
    $(document).ready(function() {
      	...
      	$('.btn-tambah-kategori').on('click',function(){
            ...
            $("#modaltambahkategori #submit-kategori").removeAttr("disabled").button('refresh');
            $("#modaltambahkategori #update-kategori").attr("disabled", "disabled").button('refresh');
              ...
              $('.btn-edit').on('click',function(){
                  ...
                  $.ajax({
                      ...
                      success:function(data){
                          ...
                          $("#modaltambahkategori #update-kategori").removeAttr("disabled").button('refresh');
                          $("#modaltambahkategori #submit-kategori").attr("disabled", "disabled").button('refresh');
