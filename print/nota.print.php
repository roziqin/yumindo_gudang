...
<head>
<link rel="stylesheet" href="../assets/css/style-print.css?a">
...
<body onLoad="window.print()" style=" font-size: 12px;">
    <div class="wrapper">
      ...
      <table width="100%" border="0">
        ...
        <tr>
          <td colspan="4" style="font-size: 9px; padding-top: 3px;" align="center">*BARANG YANG SUDAH DIBELI TIDAK DAPAT DIKEMBALIKAN</td>
        </tr>
      </table>
  </div>
</body>
